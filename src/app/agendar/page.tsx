          ...
          {submitted && (
            ...
            <form className="mt-8" onSubmit={handleSubmit}>
              <div className="grid gap-3 md:grid-cols-2">
                ...
                <div className="md:col-span-2 rounded-[18px] border border-amber-200 bg-[linear-gradient(135deg,#fff9e8_0%,#fff3d6_100%)] p-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div><p className="text-sm font-black text-amber-950">A equipe definirá a data e o horário</p><p className="mt-1 text-xs font-semibold leading-relaxed text-amber-900">O médico entrará em contato pelo ID do Discord informado ou pelo telefone da cidade para combinar o agendamento.</p></div>
                  </div>
                </div>
              ...
              <p className="mt-4 rounded-[14px] border border-hpsr-border bg-[#fcf6ee] p-3.5 text-sm leading-relaxed text-hpsr-muted">
                Após o envio, aguarde o contato do médico pelo ID do Discord informado ou pelo telefone da cidade. A consulta só será confirmada depois que o dia e o horário forem combinados.
              </p>
            </form>
          </div>
        </div>
