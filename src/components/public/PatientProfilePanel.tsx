    ...
    <div className="mx-auto max-w-3xl">
      ...
      <form onSubmit={save} className="rounded-[18px] border border-hpsr-border bg-[#fffaf4] p-4 sm:p-5">
        <div className="grid gap-4 sm:grid-cols-2">
          ...
          <ProfileField label="ID do Discord"><input className="portal-input" inputMode="numeric" value={profile.discord} onChange={(e)=>setProfile(v=>({...v,discord:normalizeDiscordId(e.target.value)}))} placeholder="ID numérico do seu perfil" /><span className="mt-1.5 block text-[11px] font-semibold text-hpsr-muted">Contato preferencial da equipe. Use o ID do perfil/usuário do Discord, não o passaporte da cidade.</span></ProfileField>
