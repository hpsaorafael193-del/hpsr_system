      ...
      <section className="rounded-[18px] border border-hpsr-border bg-white/90 p-3.5 sm:p-4">
        <div className="flex flex-col gap-3 border-b border-hpsr-border/70 pb-3 sm:flex-row sm:items-center sm:justify-between">
          <div className="flex items-start gap-3">
            ...
            <div><h3 className="text-base font-black text-hpsr-text">Meus acompanhamentos</h3><p className="mt-1 text-xs font-semibold leading-relaxed text-hpsr-muted">Acompanhamentos são conduzidos pelo médico responsável. Você não precisa abrir uma nova solicitação para manter o vínculo.</p></div>
          </div>
